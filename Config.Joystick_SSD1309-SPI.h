...
#define DISPLAY_OLED       SSD1309_SW_SPI // SH1106, OLED 1.3" I2C display commonly used. SSD1306 is a 0.96" OLED display.    Infreq
...
#define SERIAL_RADIO                 BOTH //    OFF, Allow BLUETOOTH, WIFI_STATION, or BOTH OnStep connections (ESP32 only.)  Option
